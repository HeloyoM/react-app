...
function AddVacation() {
    ...
    var _f = react_1.useState(''),
        lastUpdate = _f[0],
        setLastUpdate = _f[1];
    var onImgChange = function(event) {
        setImg(event.target.value);
    };
    var onTitelChange = function(event) {
    ...
    function onAddBtnClicked() {
        ...
        axios_1["default"].post("http://localhost:3002/vacations", postPacket)
            .then(function(response) {
    ...
    return (react_1["default"].createElement("div", { className: "AddVacation" },
        "import an image:",
        react_1["default"].createElement("br", null),
        react_1["default"].createElement("input", { className: "InputVacationDetails", type: "text", placeholder: "Img Src", onChange: onImgChange }),
        react_1["default"].createElement("input", { className: "InputVacationDetails", placeholder: "Title", onChange: onTitelChange }),
        react_1["default"].createElement("input", { className: "InputVacationDetails", placeholder: "Dscription Of Vacation", onChange: onDscriptionChange }),
        ...
        react_1["default"].createElement("input", { className: "InputVacationDetails", placeholder: "LastUpdate", onChange: onLastUpdateChange }),
        react_1["default"].createElement("br", null),
        react_1["default"].createElement("button", { className: "AddBtn", onClick: onAddBtnClicked }, "ADD")));
}
